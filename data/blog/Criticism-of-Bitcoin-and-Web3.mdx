...
<code>MultiLocation</code>- <code>Parachain(42)/AccountKey20(0x1234...abcd)</code>
指定了平行链中的20-byte账户 - <code>../AccountId32(0x1234...cdef)</code>指定了同一平行链的32-byte账户

<code>MultiAsset</code>
```rust
struct MultiAsset {
   id: AssetId,
   fun: Fungibility,
...
- <code>Abstract</code>允许<code>AssetId</code>作为名字
- <code>Concrete</code>的对象则是路径
